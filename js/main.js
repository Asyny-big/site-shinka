document.addEventListener('DOMContentLoaded', function() {
    ...
    const welcomeMessage = '👋 Здравствуйте!\nЯ онлайн-консультант шиномонтажа.\nСпросите про услуги, цены или время работы.';
    ...
    function getLocalFallback(message) {
        ...
        if (lower.match(/(привет|здравств|добр)/)) {
            return 'Здравствуйте! К сожалению, сейчас я работаю в ограниченном режиме. Позвоните нам: +7 (950) 172-55-14';
        }
        
        return 'Извините, сейчас связь с консультантом временно недоступна.\nПозвоните нам: +7 (950) 172-55-14';
    }
